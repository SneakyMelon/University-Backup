	...
	<section class="success btn-only">
		<div class="container">
			...
			<?php 
				...
				if ($_SESSION["id"] > 0)
				{
					echo '<a href="buy.php?buy=business" class="btn btn-lg btn-outline">';
				}
				else
				{
					echo '<a href="login.php?redirect" class="btn btn-lg btn-outline">';
				}				
			?>
	...
	<section class="success btn-only">
		<div class="container">
			...
			<?php 
				...
				if ($_SESSION['id'] > 0)
				{
					echo '<a href="buy.php?buy=premium" class="btn btn-lg btn-outline">';
				}
				else
				{
					echo '<a href="login.php?redirect" class="btn btn-lg btn-outline">';
