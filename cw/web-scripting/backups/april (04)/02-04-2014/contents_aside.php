<aside>
    <div id="side-columb">                
        <div class="side-item">
            <h3>New Website</h3>
            <p> 
                Welcome to Balmoral's new slick Webite, 
        ...
        <div class="side-item hide-on-device">
            <h3>Search for other Casltes</h3>
        ...
        <div class="side-item">
            ...
            <form action="newsletter.php" method="post">
				...
				<input name="name" type="text" required="yes" placeholder="e.g. Allan Davidson">
			
				<label for="email">E-mail</label>
				<input name="email" type="email" placeholder="e.g. someone@example.com" required>
