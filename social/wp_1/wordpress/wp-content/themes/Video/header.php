...
<img src="<?php if (get_option('ptthemes_logo_url') <> "" ){ echo get_option('ptthemes_logo_url'); } else echo get_template_directory_uri().'/skins/'.str_replace('.css','',get_option('ptthemes_alt_stylesheet')).'/logo.png'; }?>" alt="<?php bloginfo('name'); ?>" />			
 </a></div>
